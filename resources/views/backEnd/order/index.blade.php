                ...
                <table id="datatable-buttons" class="table table-striped   w-100">
                    <thead>
                        <tr>
                            ...
                            <th style="width:10%">Customers</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @forelse($value->orderdetails as $product)
                                <p>{{$product->product_name}} X {{$product->qty}}</p>
                                 @if(isset($product->product_size) || isset($product->product_color))
                                 
                                 <p>Variant: {{$product->product_size}}{{$product->product_color}} </p>
                                 @endif
                                @empty
                                @endforelse
                            </td>
                            
                            <td><strong>{{$value->shipping?$value->shipping->name:''}}</strong><p>{{$value->shipping?$value->shipping->address:''}}</p><p>{{$value->shipping?$value->shipping->phone:''}}</p></td>
