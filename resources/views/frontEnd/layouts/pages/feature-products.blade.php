    ...
    <section class="product-section">
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="showing-data">
                                    <span>Showing {{ $featureproducts->firstItem() }}-{{ $featureproducts->lastItem() }} of {{ $featureproducts->total() }} Results</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="row">
                ...
                row-gap: 5rem;">
                            @foreach ($featureproducts as $key => $value)
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="custom_paginate">
                        {{$featureproducts->links('pagination::bootstrap-4')}}
