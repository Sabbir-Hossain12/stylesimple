...
<html lang="en">
   ...
   <section class="text-center p-5 " style="background-color:
green ">
    <h2 class="text-white"> {{$campaign_data->banner_title}}</h2>
    </section>
...
green ">
      ...
      {{-- <section>
        ...
        <section class="p-5">
          ...
          <section class="p-5" style="background-color:
green ">
            <div class="container">
                <div class="row">
                    <h2 class="text-center p-3 text-warning">{{$product->name}}</h2>
...
<section>
    <div class="container text-center">
        <div class="row">
            <h2 class="p-5 text-danger">দয়া করে ১০০% কনফার্ম না হয়ে অর্ডার করবেন না, অর্ডার করে আপনি যদি পার্সেলটি না নেন আমাদের ১৫০ টাকা লস হয়।</h2>

        </div>
        <a href="#order_form" class="cam_order_now mb-3" id="cam_order_now"><i class="fa-solid fa-cart-shopping"></i> অর্ডার করুন </a>
    </div>
</section>
...
<section style="background-color: green;">
    ...
    <div class="container text-center pt-5"> <!-- Add text-center here -->
    <div class="row">
        <div class="row justify-content-center"> <!-- Center row content -->
            @foreach(Cart::instance('shopping')->content() as $value)
                <h1 class="btn btn-dark text-center my-2" style="font-size: 20px; width: 300px;">
                    মূল্য {{$value->price * $value->qty}} টাকা
                </h1>
            @endforeach
         </div>
    </div>
...
<section style="background-color: green;">
    ...
    <div class="container text-center pb-5"> <!-- Add text-center here -->
    <div class="row">
        <div class="row justify-content-center"> <!-- Center row content -->
           <h1 class="text-center btn btn-dark mt-4   " style="font-size: 20px; width: 500px ;">
            অর্ডার করতে অগ্রিম কোন টাকা দিতে হবে না, পন্য হাতে পেয়ে <br> দেখে টাকা দিবেন
        </h1>
         </div>
    </div>
    </div>
...
<section style="background-color: #f9f9f9; padding: 50px 0;">
    <div class="container text-center">
        @if($campaign_data->image_three)
            <div class="campro_img_item" style="margin: 0 auto; max-width: 600px; border-radius: 15px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                <img src="{{asset($campaign_data->image_three)}}" alt="Campaign Image" style="width: 100%; height:330px; display: block;">
            </div>
        @endif
        <a href="#order_form" class="cam_order_now mt-3" id="cam_order_now"><i class="fa-solid fa-cart-shopping"></i> অর্ডার করুন </a>
    </div>
</section>
             ...
             <div class="col-sm-12">
                <div class="form_inn">
                    <div class="col-sm-12">
                        <div class="row">
                <div class="col-sm-12">
                    <h2 class="campaign_offer p-3">সতর্কবার্তা : আমাদের ছবি ব্যবহার করে অনেক পেজে খারাপ কোয়ালিটির প্রোডাক্ট বিক্রি করছে। তো দয়া করে ওইসব পেজ থেকে দূরে থাকেন। আর আমাদের জ্যাকেটে আমারা ব্যাবহার করেছি চায়না বন্ডেড ফেব্রিক। দয়া করে কোয়ালিটি দেখে জ্যাকেট ক্রয় করুন ধন্যবাদ।</h2>
                </div>
            </div>
