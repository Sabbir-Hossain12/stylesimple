                    ...
                    <form action="{{ route('customer.ordersave') }}" method="POST" data-parsley-validate="">
                        ...
                        <div class="card">
                           <div class="card-header">
                                <h6> ১০০% শিওর হয়ে অর্ডারটা করুন এবং অর্ডারটা  কনফার্ম করতে  <span style="color:#fe5200;">"অর্ডার করুন"</span> বাটন এ ক্লিক করুন অথবা ফোনে অর্ডার করতে এই নাম্বার <a href="tel:{{$contact->hotline}}">{{$contact->hotline}}</a> এর উপরে ক্লিক করুন।   </h6>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!--Select Elements for Delivery Area-->
                                            ...
                                            @foreach ($shippingcharge as $key => $value)
                                                <div class="form-check">
                                                    <input type="radio" id="area{{ $value->id }}" name="area" value="{{ $value->id }}"
                                                        class="form-check-input @error('area') is-invalid @enderror" {{ $loop->first ? 'checked' : '' }} required>
